...
function buildInvoicePayload(supplierId, importerId) {
    ...
    return {
        ...
        total_weight_net: parseFloat(parseDecimalToDot(document.getElementById("total-weight-net")?.value || "0")),
        total_weight_gross: parseFloat(parseDecimalToDot(document.getElementById("total-weight-gross")?.value || "0")),
        total_num_packages: parseFloat(parseDecimalToDot(document.getElementById("total-num-packages")?.value || "0")),
