...
function upcomingEvent(a) {
    ...
    Array.from(a).forEach(function (element) {
        ...
        if (e_dt == "Invalid Date" || e_dt == undefined) {
            ...
            const newDate = new Date(e_dt).toLocaleDateString('bs', { year: 'numeric', month: 'numeric', day: 'numeric' });
        ...
        if (startDate === "Invalid Date" || startDate === undefined) {
            ...
            const newDate = new Date(startDate).toLocaleDateString('bs', { year: 'numeric', month: 'numeric', day: 'numeric' });
        ...
        u_event = "<div class='card mb-3'>\
                        <div class='card-body'>\
                            <div class='d-flex mb-3'>\
                                ...
                                <div class='flex-shrink-0'><small class='badge bg-info-subtle text-info ms-auto'>" + e_time_s + e_time_e + "</small></div>\
                            </div>\
