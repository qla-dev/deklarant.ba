                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                ...
                                <div class="row align-items-end">
                                    <div class="col-sm-8">
                                        <div class="p-3">
                                            <p class="fs-16 lh-base">Dobro došli <span class="fw-semibold">{{Auth::user()->name}},
                                                    </span> <br> na platformu eDEKLARANT!</p>
                                            <div class="mt-3">
                                                <a href="pages-pricing" class="btn btn-info"><img style="margin-top: -2px; margin-right: 3px;" src="{{ URL::asset('build/images/svg-icons/scan.svg') }}"
                                                >Smart Scan
                                                    </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="px-2">
                                            <img src="{{ URL::asset('build/images/user-illustarator-1.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                                            ...
                                            <img src="{{ URL::asset('build/images/svg-icons/scan-info.svg') }}" class="img-fluid"
                                            alt="">
                                            </span>
                                        </div>
                                    </div>
