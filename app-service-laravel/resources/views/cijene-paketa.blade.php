...
<div class="row justify-content-center mb-2">
    <div class="col-lg-5 mt-4 mb-4">
        <div class="text-center pb-2">
            <h4 class="fw-semibold fs-22">Odaberi paket koji odgovara tvojim potrebama <span class="fs-17" style="color:gray!important">(odustani bez naknade bilo kada)</span></h4>
