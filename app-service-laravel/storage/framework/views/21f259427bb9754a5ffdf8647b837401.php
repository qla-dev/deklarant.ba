                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-start flex-wrap gap-4">
                                    ...
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>"
                                            class="avatar-md rounded-4 shadow" alt="rounded-4">
                                        <p><code>.rounded-4</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>"
                                            class="avatar-md rounded-5 shadow" alt="rounded-5">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\edeklarant\app-service-laravel\resources\views/ui-utilities.blade.php ENDPATH**/ ?>