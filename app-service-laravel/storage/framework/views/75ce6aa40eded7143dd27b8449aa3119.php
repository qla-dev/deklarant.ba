                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-header border-bottom-dashed p-4 d-flex justify-content-between">
                                <div>
                                    <img src="<?php echo e(URL::asset('build/images/logo.svg')); ?>" class="card-logo" alt="logo" height="30">
                                    <div class="mt-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\edeklarant\app-service-laravel\resources\views/apps-invoices-create.blade.php ENDPATH**/ ?>